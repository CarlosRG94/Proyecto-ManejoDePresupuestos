...
namespace ManejoDePresupuestos.Controllers
{
    public class TransaccionesController:Controller
    {
        ...
        public async Task <IActionResult> Index(int mes, int año)
        {
            ...
            var modelo = await servicioReportes.ObtenerReporteTransaccionesDetalladas(usuarioId, mes,
                año, ViewBag);
            return View(modelo);
        }
        public async Task<IActionResult> Semanal(int mes, int año)
        {
            ...
            var diasDelMes = Enumerable.Range(1, fechaReferencia.AddMonths(1)
                .AddDays(-1).Day);
        ...
        public async Task<IActionResult> Crear(TransaccionCreacionViewModel modelo)
        {
            ...
            var cuenta = await repositorioCuentas.ObtenerPorId(usuarioId,modelo.CuentaId);
            if (cuenta == null)
            {
